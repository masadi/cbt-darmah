    ...
    getBeritaAcara: function getBeritaAcara() {
      ...
      this.$http.get('/referensi/berita-acara', {
        ...
        if (blangko_3_tahun) {
          ...
          _this.start_3 = blangko_3_tahun.start.toString();
          _this.end_3 = blangko_3_tahun.end.toString();
        }
        var blangko_4_tahun = response.data.blangko_4_tahun;
        if (blangko_4_tahun) {
          _this.jumlah_4 = blangko_4_tahun.jumlah;
          _this.start_4 = blangko_4_tahun.start.toString();
          _this.end_4 = blangko_4_tahun.end.toString();
        }
      ...
      _c(
        "b-modal",
        {
          ...
          attrs: {
            ...
            size: "lg",
            title: "Unggah Berkas Berita Acara",
          },
        ...
        [
          _c("b-form-file", {
            attrs: {
              ...
              placeholder: "Unggah Berkas Berita Acara...",
