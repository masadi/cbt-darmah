...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    imgUrl: function imgUrl() {
      if (_store__WEBPACK_IMPORTED_MODULE_10__["default"].state.appConfig.layout.skin === 'dark') {
        this.appLogoKemdikbud = __webpack_require__(/*! @/assets/images/logo/logo-name.png */ "./resources/js/src/assets/images/logo/logo-name.png");
        //return this.appLogoKemdikbud
      } else {
        this.appLogoKemdikbud = __webpack_require__(/*! @/assets/images/logo/logo-name.svg */ "./resources/js/src/assets/images/logo/logo-name.svg");
      }
      return this.appLogoKemdikbud;
    }
  },
  setup: function setup() {
    ...
    var _$themeConfig$app = _themeConfig__WEBPACK_IMPORTED_MODULE_12__["$themeConfig"].app,
      ...
      appLogoKemdikbud = _$themeConfig$app.appLogoKemdikbud;
    console.log(_store__WEBPACK_IMPORTED_MODULE_10__["default"].state.appConfig.layout.skin);
    return {
      bookmarks: bookmarks,
      perfectScrollbarSettings: perfectScrollbarSettings,
      ...
      appName: appName,
      appLogoKemdikbud: appLogoKemdikbud
    };
  }
});
      ...
      return _c(
        ...
        [
          _c("img", {
            ...
            attrs: { src: _vm.imgUrl, alt: _vm.appName, title: _vm.skin },
          }),
        ]
      )
    }),
...
/***/ "./resources/js/src/assets/images/logo/logo-name.png":
/*!***********************************************************!*\
  !*** ./resources/js/src/assets/images/logo/logo-name.png ***!
  \***********************************************************/
/*! no static exports found */
...
throw new Error("Module build failed (from ./node_modules/img-loader/index.js):\nError: ENOENT: no such file or directory, open 'd:\\WinNMP\\WWW\\simazah\\resources\\js\\src\\assets\\images\\logo\\logo-name.png'");
