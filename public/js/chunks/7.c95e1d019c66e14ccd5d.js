...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    BButtonGroup: bootstrap_vue__WEBPACK_IMPORTED_MODULE_2__["BButtonGroup"],
    BButton: bootstrap_vue__WEBPACK_IMPORTED_MODULE_2__["BButton"]
  },
  ...
  methods: {
    confirmVariant: function confirmVariant(item) {
      var data = Object(d_WinNMP_WWW_simazah_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
        0: 'secondary',
        1: 'success',
        2: 'warning'
      }, "2", 'danger');
    ...
    confirm: function confirm(item, status) {
      ...
      var text;
      if (status == 1) {
        text = 'Aksi ini akan melaporkan Blangko Diterima ada!';
      }
      if (status == 2) {
      ...
      this.$swal({
        ...
        if (result.value) {
          _this.$http.post('/referensi/make-fire', {
            fire: item.user.fire,
