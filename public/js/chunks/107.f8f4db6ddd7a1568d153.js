            ...
            if (userData.user) {
              ...
              _this.$router.replace('/').then(function () {
                _this.$toast({
                  ...
                  position: 'top-right',
                  props: {
                    title: "Welcome ".concat(userData.user.name),
                    icon: 'CoffeeIcon',
                    variant: 'success',
                    text: "You have successfully logged in as ".concat(userData.user.role, ". Now you can start to explore!")
                  }
                });
              });
            } else {
              ...
              if (userData.errors) {
                _this.error_username = userData.errors.username ? userData.errors.username[0] : null;
                _this.$refs.loginForm.setErrors(userData.errors);
              }
                                    ...
                                    directives: [
                                      {
                                        name: "show",
                                        rawName: "v-show",
                                        value: _vm.error_username,
                                        expression: "error_username",
                                      },
                                    ],
                                    staticClass: "text-danger",
                                  },
