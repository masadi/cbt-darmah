...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    resetDetil: function resetDetil() {
      this.smk_3_tahun = null;
      this.smk_4_tahun = null;
    },
    ...
    detil: function detil(item) {
      ...
      this.$http.post('/blangko/wilayah', {
        ...
        if (getData.blangko_3_tahun) {
          console.log(getData.blangko_3_tahun);
          ...
          /*this.smk_3_tahun = {
            ...
            start: getData.blangko_3_tahun.start,
            end: getData.blangko_3_tahun.end,
          }*/
        }
        ...
        if (getData.blangko_4_tahun) {
          ...
          /*this.smk_4_tahun = {
            diterima: getData.blangko_4_tahun.jumlah,
            start: getData.blangko_4_tahun.start,
            end: getData.blangko_4_tahun.end,
          }*/
        }
