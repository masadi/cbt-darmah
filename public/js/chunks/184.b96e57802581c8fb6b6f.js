    ...
    getBeritaAcara: function getBeritaAcara() {
      ...
      this.$http.get('/referensi/berita-acara', {
        ...
        if (_this.data) {
          ...
          _this.link_cetak = app_url + '/cetak/berita-acara/Pendistribusian/' + _this.data.id;
        } else {
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("b-card-title", [
            _c("h2", [_vm._v("Berita Acara Pendistribusian Blanko Ijazah")]),
          ]),
          _vm._v(" "),
          _c(
            "div",
      ...
      _vm._v(" "),
      _c("b-card-body", [
        _c("p", [_vm._v("Saya yang bertanda tangan dibawah ini:")]),
        _vm._v(" "),
        _c("table", [
          _c("tr", [
            _c("td", [_vm._v("Nama")]),
