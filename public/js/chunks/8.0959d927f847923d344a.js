  ...
  methods: {
    ...
    getwaktu: function getwaktu(ujian_id) {
      ...
      this.$http.post('/ujian/waktu', {
        ...
        if (getData) {
          ...
          _this2.all_soal = getData.jumlah_soal;
        }
      });
    },
    chunked: function chunked() {
      return lodash__WEBPACK_IMPORTED_MODULE_2___default.a.chunk(this.all_soal, this.itemsPerRow);
    },
    ...
    getSoal: function getSoal(ujian_id, nomor, replace) {
      ...
      this.$http.post('/ujian/index', {
        ...
        _this3.soal_id = getData.soal.soal_id;
    ...
    lanjutNav: function lanjutNav(nomor_ujian) {
      var _this4 = this;
      this.isBusy = true;
    ...
    lanjut: function lanjut(soal_id, nomor, nav) {
      ...
      this.$http.post('/ujian/simpan', {
        ...
        _this5.getSoal(_this5.$route.params.ujian_id, nomor_ujian, true);
      });
    },
