...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    BIconHdd: bootstrap_vue__WEBPACK_IMPORTED_MODULE_0__["BIconHdd"],
  ...
  methods: {
    onSubmit: function onSubmit(event) {
      ...
      this.$http.post('/dashboard/data-dapodik', {
        ...
        if (data.data) {
          ...
          _this.ambil_data(_this.form.npsn, _this.form.email, _this.form.password, data.data.sekolah_id);
        } else {
          _this.alert = true;
    ...
    ambil_data: function ambil_data(npsn, email, password, sekolah_id) {
      var data = ['sekolah', 'ptk', 'rombongan-belajar', 'peserta-didik-aktif', 'peserta-didik-keluar', 'anggota-rombel-pilihan', 'pembelajaran', 'ekstrakurikuler', 'anggota-ekskul', 'dudi'];
      console.log(data);
    }
  }
});
