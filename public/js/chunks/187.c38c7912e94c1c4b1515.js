  ...
  methods: {
    ...
    handleSubmit: function handleSubmit() {
      ...
      this.$http.post('/blangko/sekolah', {
        ...
        var data = response.data;
        if (data.errors) {
          _this4.nomor_seriState = data.errors.nomor_seri ? false : true;
          _this4.nomor_seri_baruState = data.errors.nomor_seri_baru ? false : true;
          _this4.jenis_pengembalian_id_baruState = data.errors.jenis_pengembalian_id ? false : true;
          _this4.feedback_nomor_seri = data.errors.nomor_seri ? data.errors.nomor_seri[0] : null;
          _this4.feedback_nomor_seri_baru = data.errors.nomor_seri_baru ? data.errors.nomor_seri_baru[0] : null;
          _this4.feedback_jenis_pengembalian_id = data.errors.jenis_pengembalian_id ? data.errors.jenis_pengembalian_id[0] : null;
        } else {
          _this4.$swal({
            icon: data.icon,
            title: data.title,
            ...
            _this4.$refs['modal-sekolah'].show();
              ...
              _c(
                "b-form-group",
                {
                  attrs: {
                    ...
                    "invalid-feedback": _vm.invalid_wilayah,
                    state: _vm.wilayahState,
                  },
                },
                [
                  _c("b-form-select", {
              ...
              _c(
                "b-form-group",
                {
                  attrs: {
                    ...
                    "invalid-feedback": _vm.invalid_sekolah,
                    state: _vm.sekolahState,
                  },
                },
                [
                  _c("b-form-select", {
