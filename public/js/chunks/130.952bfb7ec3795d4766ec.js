...
//import { BRow, BCol, BTable, BSpinner, BPagination, BDropdown, BDropdownItem, BBadge, BAlert, BProgress, BButtonGroup, BButton, BFormGroup, BFormSelect, BModal } from 'bootstrap-vue'
  ...
  methods: {
    ...
    preview: function preview(item) {
      ...
      this.$http.get('/berita-acara/baca', {
        ...
        var getData = response.data.data;
        console.log(getData);
        _this5.previewUrl = 'https://drive.google.com/file/d/' + getData.file_id + '/preview';
        _this5.$refs['modal-preview'].show();
      });
    },
    handleOk: function handleOk(bvModalEvent) {
      // Prevent modal from closing
