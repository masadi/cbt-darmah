  ...
  methods: {
    getBeritaAcara: function getBeritaAcara() {
      ...
      this.$http.get('/referensi/berita-acara', {
        ...
        _this.ganti = response.data.ganti;
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("b-card-title", [
            _c("h2", [_vm._v("Berita Acara Pengembalian Blanko Ijazah")]),
          ]),
          _vm._v(" "),
          _c(
            "div",
      ...
      _c("b-card-body", [
        ...
        _c("table", { staticClass: "table table-bordered" }, [
          ...
          _c(
            "tbody",
            [
              _vm._l(_vm.ganti, function (item, index) {
                return _c("tr", [
                  _c("td", { staticClass: "text-center" }, [
              ...
              _c("tr", [
                ...
                _vm._v(" "),
                _c("td", { staticClass: "text-center" }, [
                  _vm._v(_vm._s(_vm.ganti.length) + " lembar Blanko Ijazah"),
                ]),
                _vm._v(" "),
                _c("td", { staticClass: "text-center" }),
              ]),
                  ...
                  directives: [
                    {
                      name: "show",
                      rawName: "v-show",
                      value: !_vm.ganti.length,
                      expression: "!ganti.length",
                    },
                  ],
                },
                [
