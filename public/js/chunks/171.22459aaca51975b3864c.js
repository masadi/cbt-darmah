  ...
  methods: {
    ...
    handleSubmitPassword: function handleSubmitPassword() {
      ...
      this.$http.post('/referensi/users/update-profile', {
        ...
        var data = response.data;
        if (data.errors) {
          _this3.current_password_State = data.errors.name ? false : null;
          _this3.feedback_name = data.errors.name ? data.errors.name[0] : '';
          _this3.email_State = data.errors.email ? false : null;
          _this3.feedback_email = data.errors.email ? data.errors.email[0] : '';
          _this3.no_hp_State = data.errors.no_hp ? false : null;
          _this3.feedback_no_hp = data.errors.no_hp ? data.errors.no_hp[0] : '';
        } else {
                                  ...
                                  directives: [
                                    {
                                      name: "show",
                                      rawName: "v-show",
                                      value: _vm.feedback_current_password,
                                      expression: "feedback_current_password",
                                    },
                                  ],
                                  staticClass: "text-danger",
                                },
