...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    konfirmasi: function konfirmasi(text, aksi, peserta_didik_id) {
      ...
      this.$swal({
        ...
        if (result.value) {
          if (aksi == 'keluar') {
            _this.$swal({
              title: 'Pilih Jenis Non Penerima',
              input: 'select',
              inputOptions: {
                2: "Mutasi",
                3: "Dikeluarkan",
              ...
              inputPlaceholder: '== Pilih Jenis Non Penerima ==',
              showCancelButton: true,
              customClass: {
                confirmButton: 'mr-1'
              },
              ...
              inputValidator: function inputValidator(value) {
                return new Promise(function (resolve) {
                  if (value) {
                    ...
                    resolve('Jenis Non Penerima tidak boleh kosong!');
                  }
                });
              }
            });
    ...
    luluskan: function luluskan(item) {
      this.konfirmasi("Aksi ini akan menentukan Peserta Didik sebagai Penerima!", 'lulus', item.peserta_didik_id);
    },
    keluarkan: function keluarkan(item) {
      this.konfirmasi("Aksi ini akan menentukan Peserta Didik sebagai Non Penerima!", 'keluar', item.peserta_didik_id);
    },
