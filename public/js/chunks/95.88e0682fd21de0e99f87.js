  ...
  methods: {
    ...
    loadPostsData: function loadPostsData() {
      ...
      this.$http.get('/referensi/users', {
        ...
        console.log(_this2.data_wilayah);
      });
    },
    //JIKA ADA EMIT TERKAIT LOAD PERPAGE, MAKA FUNGSI INI AKAN DIJALANKAN
    handlePerPage: function handlePerPage(val) {
                ...
                _vm._v(
                  "\n            " +
                    _vm._s(
                      row.item.kcd
                        .map(function (entry) {
                          return entry.wilayah.nama
                        })
                        .join(", ")
                    ) +
                    "\n            "
                ),
                _vm._l(row.item.kcd, function (wilayah) {
                  return _c("span", [
                    _vm._v(
                      "\n                " +
                        _vm._s(wilayah.wilayah.nama) +
                        "\n            "
                    ),
                  ])
                }),
                      ...
                      scopedSlots: _vm._u([
                        {
                          ...
                          fn: function (ref) {
                            ...
                            return [
                              _vm._l(_vm.data_wilayah, function (option) {
                                return _c(
                                  "b-form-checkbox",
                                  {
