    ...
    handleSubmit: function handleSubmit() {
      ...
      this.$http.post('/referensi/users/add', {
        ...
        if (data.errors) {
          ...
          _this.name_feedback = data.errors.tanggal ? data.errors.tanggal[0] : '';
          _this.email_state = data.errors.email ? false : null;
          _this.email_feedback = data.errors.tanggal ? data.errors.tanggal[0] : '';
          _this.kode_wilayah_state = data.errors.kode_wilayah ? false : null;
          _this.kode_wilayah_feedback = data.errors.tanggal ? data.errors.tanggal[0] : '';
          _this.password_state = data.errors.password ? false : null;
          _this.password_feedback = data.errors.tanggal ? data.errors.tanggal[0] : '';
        } else {
          _this.$swal({
            icon: data.icon,
            title: data.title,
