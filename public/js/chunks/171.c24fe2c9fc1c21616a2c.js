...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    handleSubmit: function handleSubmit() {
      var _this2 = this;
      this.$http.get('/referensi/users/update-profile').then(function (response) {
        var data = response.data;
        _this2.dismissCountDownProfile = _this2.dismissSecs;
        _this2.alert_variant = 'success';
        _this2.alert_title = 'Berhasil';
        _this2.alert_text = 'Berhasil cuy';
      });
    },
