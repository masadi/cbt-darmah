...
/* harmony import */ var _datatables_TablePenerimaan_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./datatables/TablePenerimaan.vue */ "./resources/js/src/views/dashboard/berita-acara/datatables/TablePenerimaan.vue");
          ...
          },
          {
            ...
            fn: function (row) {
              return [
                _c(
                  "b-badge",
                  { attrs: { variant: _vm.confirmVariant(row.item.status) } },
                  [_vm._v(_vm._s(_vm.statusConfirm(row.item.status)))]
                ),
              ]
            },
          },
              ...
              return [
                _c(
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _vm.cadangan && !row.item.peserta_didik_id
                      ? _c(
                          "b-dropdown-item",
                          {
                            attrs: { href: "javascript:" },
