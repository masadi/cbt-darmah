  ...
  methods: {
    ...
    handleSubmit: function handleSubmit() {
      ...
      this.$http.post('/referensi/users/add', {
        ...
        var data = response.data;
        if (data.errors) {
          _this.feedback_tanggal = data.errors.tanggal ? data.errors.tanggal[0] : '';
          _this.tanggalState = data.errors.tanggal ? false : null;
          _this.name_state = data.errors.tanggal ? false : null;
          _this.name_feedback = '';
          _this.email_state = data.errors.tanggal ? false : null;
          _this.email_feedback = '';
          _this.kode_wilayah_state = data.errors.tanggal ? false : null;
          _this.kode_wilayah_feedback = '';
          _this.password_state = data.errors.tanggal ? false : null;
          _this.password_feedback = '';
        } else {
          _this.$swal({
            icon: data.icon,
            title: data.title,
