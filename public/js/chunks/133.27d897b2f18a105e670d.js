  ...
  methods: {
    ...
    loadPostsData: function loadPostsData() {
      ...
      this.$http.get('/blangko/diterima', {
        ...
        console.log(_this2.optionsKabupaten);
      });
    },
                    ...
                    on: {
                      change: [
                        function ($event) {
                          ...
                          _vm.kabupaten_id = $event.target.multiple
                            ? $$selectedVal
                            : $$selectedVal[0]
                        },
                        _vm.loadKabupaten,
                    ...
                    on: {
                      change: [
                        function ($event) {
                          ...
                          _vm.sekolah_id = $event.target.multiple
                            ? $$selectedVal
                            : $$selectedVal[0]
                        },
                        _vm.loadSekolah,
