...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    imgUrl: function imgUrl() {
      console.log(_store_index__WEBPACK_IMPORTED_MODULE_10__["default"].state.appConfig);
      return this.sideImg;
  ...
  methods: {
    redirectSSO: function redirectSSO() {
      window.location = "https://sso.datadik.kemdikbud.go.id/app/F77FD82E-9B70-4E91-ABC0-52BD7E497059";
    },
...
module.exports = "/images/_/_/_/_/simazah/resources/js/src/assets/images/pages/bg_login.png";
