...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    ijazah: function ijazah(item) {
      ...
      if (item.blanko) {
        this.name = item.blanko.nomor_seri;
      }
    ...
    handleSubmit: function handleSubmit() {
      ...
      console.log(this.peserta_didik_id);
      return false;
        ...
        [
          _c(
            ...
            [
              _c(
                "b-form-group",
                {
                  attrs: {
                    ...
                    "invalid-feedback": "Nomor Urut Ijazah tidak boleh kosong",
                    state: _vm.nameState,
                  },
                },
                [
              ...
              _vm._v(" "),
              _c("b-form-input", {
                attrs: { type: "text", id: "peserta_didik_id" },
                model: {
                  value: _vm.peserta_didik_id,
                  callback: function ($$v) {
                    _vm.peserta_didik_id = $$v
                  },
                  expression: "peserta_didik_id",
                },
              }),
            ],
            1
