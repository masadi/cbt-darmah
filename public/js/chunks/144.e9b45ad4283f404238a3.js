                    ...
                    directives: [
                      {
                        name: "show",
                        rawName: "v-show",
                        value: _vm.hasRole("direktorat"),
                        expression: "hasRole('direktorat')",
                      },
                    ],
                    attrs: {
                        ...
                        directives: [
                          {
                            name: "show",
                            rawName: "v-show",
                            value: !row.item.smk_pk,
                            expression: "!row.item.smk_pk",
                          },
                        ],
                        attrs: { href: "javascript:" },
                        on: {
                          click: function ($event) {
                            return _vm.tetapkanCoe(row)
                          },
                        },
                      },
                      [
                        _c("i", { staticClass: "fas fa-check" }),
                        _vm._v(" Tetapkan SMK PK"),
                      ]
                    ),
                    _vm._v(" "),
                    _c(
                      "b-dropdown-item",
                      {
                        ...
                        on: {
                          click: function ($event) {
                            return _vm.batalkanCoe(row)
                          },
                        },
                      },
                      [
                        _c("i", { staticClass: "fas fa-times" }),
                        _vm._v(" Batalkan SMK PK"),
                      ]
                    ),
                  ],
                  1
