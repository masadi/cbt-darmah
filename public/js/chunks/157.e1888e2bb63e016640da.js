      ...
      _c("b-card-body", [
        ...
        _c("table", [
          _c("tr", [
            _c("td", [_vm._v("Nama")]),
            _vm._v(" "),
            _c("td", [_vm._v(": " + _vm._s(_vm.nama))]),
          ]),
          _vm._v(" "),
          _c("tr", [
            _c("td", [_vm._v("Jabatan")]),
            _vm._v(" "),
            _c("td", [_vm._v(": " + _vm._s(_vm.jabatan))]),
          ]),
          _vm._v(" "),
          _c("tr", [
            _c("td", [_vm._v("Instansi")]),
            _vm._v(" "),
            _c("td", [_vm._v(": " + _vm._s(_vm.instansi))]),
          ]),
          _vm._v(" "),
          _c("tr", [
            _c("td", [_vm._v("Kab/Kota")]),
            _vm._v(" "),
            _c("td", [_vm._v(": " + _vm._s(_vm.kabupaten))]),
          ]),
          _vm._v(" "),
          _c("tr", [
            _c("td", [_vm._v("Provinsi")]),
            _vm._v(" "),
            _c("td", [_vm._v(": " + _vm._s(_vm.provinsi))]),
          ]),
        ]),
      ]),
    ],
