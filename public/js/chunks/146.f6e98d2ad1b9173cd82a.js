...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    tutupDetil: function tutupDetil() {
      console.log('tutupDetil');
      console.log(this.hasRole('administrator'));
      ...
      this.$swal({
        ...
        if (result.value) {
          _this.$http.post('/referensi/generate-pengguna', {
            sekolah_id: _this.detail.sekolah_id
          }).then(function (response) {
  ...
  prosesDapo: function prosesDapo() {
    ...
    this.$http.post('/referensi/proses-pd', {
      ...
      _this6.show = true;
      _this6.value = 100;
      clearInterval(_this6.polling);
      _this6.$nextTick(function () {
        _this6.$bvModal.hide('ambilDapo');
      });
