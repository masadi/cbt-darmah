      ...
      this.$http.get('/referensi/berita-acara', {
        ...
        if (_this.data) {
          ...
          if (_this.hasRole('sekolah')) {
            ...
            _this.kabupaten = _this.user.sekolah && _this.user.sekolah.kabupaten ? _this.user.sekolah.kabupaten.nama : '';
            _this.provinsi = _this.user.sekolah && _this.user.sekolah.provinsi ? _this.user.sekolah.provinsi.nama : '';
          }
        }
