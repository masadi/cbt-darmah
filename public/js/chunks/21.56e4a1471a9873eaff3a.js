...
/* harmony default export */ __webpack_exports__["default"] = ([{
  ...
  //route: 'blanko-ijazah',
  title: 'Data Blanko Ijazah',
  children: [{
    icon: 'circle-check',
    title: 'Diterima',
    route: 'blanko-ijazah-diterima',
    resource: 'Sekolah',
    action: 'read'
  }, {
    icon: 'arrow-rotate-left',
    title: 'Ditukar',
    route: 'blanko-ijazah-ditukar',
    resource: 'Sekolah',
    action: 'read'
  }, {
    icon: 'circle-xmark',
    title: 'Dikembalikan',
    route: 'blanko-ijazah-dikembalikan',
    resource: 'Sekolah',
    action: 'read'
  }]
}, {
  ...
  children: [{
    ...
    route: 'pakta-integritas-penerimaan',
    resource: 'Sekolah',
    action: 'read'
  }, {
    icon: 'arrow-rotate-left',
    title: 'Penukaran Blanko',
    route: 'pakta-integritas-penukaran',
    resource: 'Sekolah',
    action: 'read'
  }, {
    icon: 'circle-xmark',
    title: 'Pengembalian Blanko',
    route: 'pakta-integritas-pengembalian',
    resource: 'Sekolah',
    action: 'read'
  }, {
    icon: 'list-check',
    title: 'Pendistribusian Blanko',
    route: 'pakta-integritas-pendistribusian',
    resource: 'Sekolah',
    action: 'read'
  }]
}]);
