...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.$http.post('/ujian/index', {
      ...
      _this.nomor = _this.$route.query.nomor;
      _this.ujian_id = _this.$route.params.ujian_id;
    });
  },
  methods: {
    getSoal: function getSoal(ujian_id, nomor) {
      var _this2 = this;
      this.$http.post('/ujian/index', {
        ujian_id: this.$route.params.ujian_id,
        nomor: this.$route.query.nomor
        ...
        _this2.nomor = _this2.$route.query.nomor;
        _this2.ujian_id = _this2.$route.params.ujian_id;
      });
    },
    ...
    lanjut: function lanjut(soal_id, nomor, nav) {
      ...
      this.$http.post('/ujian/index', {
        ...
        _this3.nomor = _this3.$route.query.nomor;
        _this3.ujian_id = _this3.$route.params.ujian_id;
      });
    },
                          ...
                          _c(
                            ...
                            [
                              ...
                              _c(
                                ...
                                [
                                  _vm.nomor >= 40
                                    ? _c("b-button", [_vm._v("Selanjutnya »")])
                                    : _c(
                                        "b-button",
                                        {
                                          attrs: { variant: "success" },
