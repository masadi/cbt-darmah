...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    var _this = this;
    this.$http.get('/dashboard/pengguna').then(function (response) {
      _this.isBusy = false;
      _this.last_sync = response.data.last_sync;
      _this.items = response.data.wilayah;
    });
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    var _this = this;
    this.$http.get('/dashboard/persentase').then(function (response) {
      _this.isBusy = false;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    var _this = this;
    this.$http.get('/dashboard/sinkronisasi').then(function (response) {
      _this.isBusy = false;
      _this.data = response.data;
    });
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    var _this = this;
    this.$http.get('/dashboard/statistik').then(function (response) {
      _this.isBusy = false;
      _this.last_sync = response.data.last_sync;
      _this.data = response.data.statistik;
    });
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    var _this = this;
    this.$http.get('/dashboard/terbanyak').then(function (response) {
      _this.isBusy = false;
      _this.data = response.data;
    });
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    var _this = this;
    this.$http.get('/dashboard/rekapitulasi').then(function (response) {
      _this.data = response.data;
      _this.data.chartOptionsLg.tooltip = {
        y: {
      ...
      _this.data.chartOptionsSm.tooltip = {
        y: {
          formatter: function formatter(val) {
            return val + " SMK";
          }
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var bootstrap_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! bootstrap-vue */ "./node_modules/bootstrap-vue/esm/index.js");
/* harmony import */ var _DashboardTerbanyak_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DashboardTerbanyak.vue */ "./resources/js/src/views/dashboard/utama/DashboardTerbanyak.vue");
/* harmony import */ var _DashboardStatistik_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DashboardStatistik.vue */ "./resources/js/src/views/dashboard/utama/DashboardStatistik.vue");
/* harmony import */ var _DashboardWilayah_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./DashboardWilayah.vue */ "./resources/js/src/views/dashboard/utama/DashboardWilayah.vue");
/* harmony import */ var _DashboardPengguna_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./DashboardPengguna.vue */ "./resources/js/src/views/dashboard/utama/DashboardPengguna.vue");
/* harmony import */ var _DashboardPersentase_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./DashboardPersentase.vue */ "./resources/js/src/views/dashboard/utama/DashboardPersentase.vue");
/* harmony import */ var _DashboardSinkronisasi_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./DashboardSinkronisasi.vue */ "./resources/js/src/views/dashboard/utama/DashboardSinkronisasi.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    BRow: bootstrap_vue__WEBPACK_IMPORTED_MODULE_0__["BRow"],
    BCol: bootstrap_vue__WEBPACK_IMPORTED_MODULE_0__["BCol"],
    DashboardTerbanyak: _DashboardTerbanyak_vue__WEBPACK_IMPORTED_MODULE_1__["default"],
    DashboardStatistik: _DashboardStatistik_vue__WEBPACK_IMPORTED_MODULE_2__["default"],
    DashboardWilayah: _DashboardWilayah_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
    DashboardPengguna: _DashboardPengguna_vue__WEBPACK_IMPORTED_MODULE_4__["default"],
    DashboardPersentase: _DashboardPersentase_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
    DashboardSinkronisasi: _DashboardSinkronisasi_vue__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
  created: function created() {
    this.$ability.update([{
      'action': 'manage'
...
/***/ "./node_modules/css-loader/dist/cjs.js?!./node_modules/laravel-mix/node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/dashboard/utama/DashboardPengguna.vue?vue&type=style&index=0&id=5efbf675&lang=css&":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ref--6-1!./node_modules/laravel-mix/node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/dashboard/utama/DashboardPengguna.vue?vue&type=style&index=0&id=5efbf675&lang=css& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
                  ...
                  scopedSlots: _vm._u([
                    {
                      ...
                      fn: function (row) {
                        return [
                          _vm._v(
                            "\n          " +
                              _vm._s(_vm.formatRupiah(row.item.jml)) +
                              "\n        "
                          ),
                        ]
                      },
...
var render = function () {
  ...
  return _c("b-card", { staticClass: "card-congratulation-medal" }, [
    _c("h5", [_vm._v("Provinsi Pengguna Terbanyak (%)")]),
    _vm._v(" "),
    _vm.isBusy
      ? _c(
          "div",
      ...
      : _c(
          ...
          [
            _c("b-card-text", { staticClass: "font-small-3" }, [
              _vm._v("\n      " + _vm._s(_vm.data.provinsi.nama) + "\n      "),
              _c("br"),
              _vm._v(
                "\n      Jml SMK: " + _vm._s(_vm.data.nasional) + "\n      "
              ),
              _c("br"),
              _vm._v(
                "\n      Jml Pengguna: " + _vm._s(_vm.data.pengguna) + "\n    "
              ),
            ]),
            _vm._v(" "),
            _c(
              ...
              [
                _c("b-link", [
                  _vm._v("SMK Pengguna " + _vm._s(_vm.data.persentase + "%")),
                ]),
              ],
              1
            ),
            _vm._v(" "),
            _c("b-img", {
              staticClass: "congratulation-medal d-none d-xl-block",
              attrs: {
            ...
            _vm._v(" "),
            _c("b-img", {
              staticClass: "congratulation-medal d-block d-xl-none",
              staticStyle: { "max-width": "75px", right: "7px" },
              attrs: {
                src: __webpack_require__(/*! @/assets/images/illustration/badge.svg */ "./resources/js/src/assets/images/illustration/badge.svg"),
                alt: "Medal Pic",
              },
                    ...
                    [
                      _c("vue-apex-charts", {
                        ...
                        attrs: {
                          ...
                          type: "bar",
                          height: "600",
                          options: _vm.data.chartOptionsLg,
                          series: _vm.data.series,
                        },
                      }),
                      _vm._v(" "),
                      _c("vue-apex-charts", {
                        ...
                        attrs: {
                          ...
                          type: "bar",
                          height: "600",
                          options: _vm.data.chartOptionsSm,
                          series: _vm.data.series,
                        },
                      }),
                    ],
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("b-col", { attrs: { xl: "4", md: "6" } }, [
            _vm._v("\n      DashboardTerbanyak\n    "),
          ]),
          _vm._v(" "),
          _c("b-col", { attrs: { xl: "8", md: "6" } }, [
            _vm._v("\n      DashboardStatistik\n    "),
          ]),
        ],
        1
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/dist/cjs.js?!./node_modules/laravel-mix/node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/dashboard/utama/DashboardPengguna.vue?vue&type=style&index=0&id=5efbf675&lang=css&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader/dist/cjs.js??ref--6-1!./node_modules/laravel-mix/node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/dashboard/utama/DashboardPengguna.vue?vue&type=style&index=0&id=5efbf675&lang=css& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../../../../node_modules/css-loader/dist/cjs.js??ref--6-1!../../../../../../node_modules/laravel-mix/node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/src??ref--6-2!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./DashboardPengguna.vue?vue&type=style&index=0&id=5efbf675&lang=css& */ "./node_modules/css-loader/dist/cjs.js?!./node_modules/laravel-mix/node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/dashboard/utama/DashboardPengguna.vue?vue&type=style&index=0&id=5efbf675&lang=css&");
...
module.exports = "/images/_/_/_/_/simazah/resources/js/src/assets/images/illustration/badge.svg";
...
/* empty/unused harmony star reexport *//* harmony import */ var _DashboardPengguna_vue_vue_type_style_index_0_id_5efbf675_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DashboardPengguna.vue?vue&type=style&index=0&id=5efbf675&lang=css& */ "./resources/js/src/views/dashboard/utama/DashboardPengguna.vue?vue&type=style&index=0&id=5efbf675&lang=css&");
...
/***/ "./resources/js/src/views/dashboard/utama/DashboardPengguna.vue?vue&type=style&index=0&id=5efbf675&lang=css&":
/*!*******************************************************************************************************************!*\
  !*** ./resources/js/src/views/dashboard/utama/DashboardPengguna.vue?vue&type=style&index=0&id=5efbf675&lang=css& ***!
  \*******************************************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_ref_6_1_node_modules_laravel_mix_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_DashboardPengguna_vue_vue_type_style_index_0_id_5efbf675_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader!../../../../../../node_modules/css-loader/dist/cjs.js??ref--6-1!../../../../../../node_modules/laravel-mix/node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/src??ref--6-2!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./DashboardPengguna.vue?vue&type=style&index=0&id=5efbf675&lang=css& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/dist/cjs.js?!./node_modules/laravel-mix/node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/dashboard/utama/DashboardPengguna.vue?vue&type=style&index=0&id=5efbf675&lang=css&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_ref_6_1_node_modules_laravel_mix_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_DashboardPengguna_vue_vue_type_style_index_0_id_5efbf675_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_ref_6_1_node_modules_laravel_mix_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_DashboardPengguna_vue_vue_type_style_index_0_id_5efbf675_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_ref_6_1_node_modules_laravel_mix_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_DashboardPengguna_vue_vue_type_style_index_0_id_5efbf675_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_ref_6_1_node_modules_laravel_mix_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_DashboardPengguna_vue_vue_type_style_index_0_id_5efbf675_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
