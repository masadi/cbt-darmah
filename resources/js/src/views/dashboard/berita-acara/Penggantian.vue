<template>
  <b-card no-body>
    <b-card-header>
      <b-card-title>
        <h2>Berita Acara Penggantian Blangko Ijazah</h2>
      </b-card-title>
    ...
    <b-card-body v-if="!hasRole('diskab')">
      ...
      <div v-show="!fire">
        ...
        <p class="mt-1 mb-0">Dengan ini menerangkan bahwa, PIHAK PERTAMA menyerahkan Blangko Ijazah yang rusak/salah tulis kepada PIHAK KEDUA dengan rincian:</p>
      </div>
      <p class="mt-1 mb-0" v-show="fire">Dengan ini menyatakan bahwa, terdapat Blangko Ijazah yang rusak/salah tulis dengan rincian sebagai berikut:</p>
      ...
      <p class="mt-1 mb-0" v-show="!fire">Selanjutnya PIHAK KEDUA menyerahkan Blangko Ijazah pengganti kepada PIHAK PERTAMA dengan rincian:</p>
      <p class="mt-1 mb-0" v-show="fire">dan dilakukan penggantian dengan Blangko Ijazah yang baru dengan rincian sebagai berikut:</p>
      <table class="table table-bordered">
        <thead>
          <tr>
            <td class="text-center">No.</td>
    ...
    <b-modal id="berita-acara" ref="modal" title="Edit Data Berita Acara Penggantian Blangko Ijazah" @show="resetModal" @hidden="resetModal" @ok="handleOk" ok-title="Simpan" cancel-title="Batal">
      <form ref="form" @submit.stop.prevent="handleSubmit">
        ...
        <!--b-form-group label="Pengawas Pembina" label-for="pengawas" :invalid-feedback="feedback_pengawas" :state="pengawasState" v-show="hasRole('sekolah')">
          <b-form-input id="pengawas" v-model="pengawas" :state="pengawasState"></b-form-input>
        </b-form-group-->
        <div v-show="!fire">
          <h3>Pihak Kedua</h3>
    ...
    <b-modal id="upload-berita-acara" title="Unggah Berita Acara Penggantian Blangko Ijazah">
    ...
    getBeritaAcara(){
      this.$http.get('/referensi/berita-acara', {
        ...
        if(this.data){
          ...
          this.link_cetak = app_url+'/cetak/berita-acara/penggantian/'+this.user.user_id
        } else {
