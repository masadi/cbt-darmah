        ...
        <b-table responsive striped :items="items" :fields="fields" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" show-empty :busy="isBusy">
            ...
            <template v-slot:cell(actions)="row">
                <b-dropdown id="dropdown-dropleft" dropleft text="Aksi" variant="success" size="sm">
                    <b-dropdown-item href="javascript:" @click="luluskan(row.item)"><i class="fas fa-check"></i> Penerima</b-dropdown-item>
                    <b-dropdown-item href="javascript:" @click="keluarkan(row.item)"><i class="fas fa-times"></i> Non Penerima</b-dropdown-item>
                </b-dropdown>
            </template>
        </b-table>
