<template>
  <b-card no-body>
    <b-card-header>
      <b-card-title>
        <h2>Data Blangko Ijazah Dimusnahkan</h2>
      </b-card-title>
    ...
    <b-modal id="modal-prevent-closing" ref="modal" title="Tambah Data Pemusnahan Blangko Ijazah" @show="resetModal" @hidden="resetModal" @ok="handleOk">
...
import TableIjazah from './IjazahDimusnahkan.vue'
