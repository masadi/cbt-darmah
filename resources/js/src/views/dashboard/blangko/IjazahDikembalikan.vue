    ...
    <div>
        ...
        <b-table responsive striped :items="items" :fields="fields" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" show-empty :busy="isBusy">
            ...
            <template v-slot:cell(actions)="row">
                <b-button variant="warning" size="sm" @click="keterangan(row.item)">Edit Keterangan</b-button>
            </template>
        </b-table>
...
import { BRow, BCol, BTable, BSpinner, BPagination, BButton, BFormGroup, BFormInput, BFormSelect } from 'bootstrap-vue'
export default {
    components: {
        BRow,
        BCol,
