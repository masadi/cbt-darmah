  ...
  <div>
    ...
    <b-form @submit="onSubmit" @reset="onReset" v-if="!isBusy">
      <b-row class="my-1">
        ...
        <b-col sm="8">
          <b-input-group>
            <b-form-input type="text" id="start_3" v-model="form.start_3" :state="stateStart_3" @keypress="NumbersOnly" @input="hitung_3"></b-form-input>
            <b-input-group-prepend is-text><b>s/d</b></b-input-group-prepend>
            <b-form-input type="text" id="end_3" v-model="form.end_3" :state="stateEnd_3" @keypress="NumbersOnly" @input="hitung_3"></b-form-input>
          </b-input-group>
      ...
      <b-row class="my-1">
        ...
        <b-col sm="8">
          <b-input-group>
            <b-form-input type="text" id="start_4" v-model="form.start_4" :state="stateStart_4" @keypress="NumbersOnly" @input="hitung_4"></b-form-input>
            <b-input-group-prepend is-text><b>s/d</b></b-input-group-prepend>
            <b-form-input type="text" id="end_4" v-model="form.end_4" :state="stateEnd_4" @keypress="NumbersOnly" @input="hitung_4"></b-form-input>
          </b-input-group>
...
export default {
  ...
  methods: {
    ...
    getBlangko(){
      this.$http.get('/referensi/blangko').then(response => {
