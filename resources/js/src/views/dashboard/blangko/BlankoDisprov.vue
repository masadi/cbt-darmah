  ...
  <div>
    ...
    <b-form @submit="onSubmit" @reset="onReset" v-if="!isBusy">
      ...
      <b-row class="my-1">
        ...
        <b-col sm="8">
          <b-input-group>
            <b-form-input type="text" id="start_4" v-model="form.start_4" :state="stateStart_4" @keypress="NumbersOnly" @input="hitung_4" placeholder="Nomor Ijazah Awal"></b-form-input>
            <b-input-group-prepend is-text><b>s/d</b></b-input-group-prepend>
            <b-form-input type="text" id="end_4" v-model="form.end_4" :state="stateEnd_4" @keypress="NumbersOnly" @input="hitung_4" placeholder="Nomor Ijazah Akhir"></b-form-input>
          </b-input-group>
