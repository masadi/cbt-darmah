<template>
  <b-navbar-nav class="nav">
    <b-nav-item
      ...
      :to="bookmark.route"
    >
      <img class="img-fluid" :src="imgUrl" :alt="appName" style="height:50px"></img>
    </b-nav-item>
...
export default {
  ...
  computed: {
    imgUrl() {
      if (store.state.appConfig.layout.skin === 'dark') {
        this.appLogoKemdikbud = require('@/assets/images/logo/logo-name.png')
        //return this.appLogoKemdikbud
      } else {
        this.appLogoKemdikbud = require('@/assets/images/logo/logo-name.svg')
      }
      return this.appLogoKemdikbud
    },
  },
  setup() {
    ...
    const { appName, appLogoKemdikbud } = $themeConfig.app
